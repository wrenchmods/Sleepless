...
BEGIN_RECV_TABLE_NOBASE(C_BaseEntity, DT_BaseEntity)
	...
	RecvPropBool( RECVINFO(m_bEnableGlow) ), RecvPropInt( RECVINFO(m_GlowColor), 0, RecvProxy_IntToColor32 )
...
void C_BaseEntity::PostDataUpdate( DataUpdateType_t updateType )
{
	...
	DevMsg("	A tutaj mamy: ClientGlow:%d, EnableGlow:%d\n", m_bClientGlow, m_bEnableGlow);
