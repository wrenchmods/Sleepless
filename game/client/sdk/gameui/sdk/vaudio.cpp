...
//
// kaitek666:	We had to remove ALL microphone and voice communication settings,
//				this is damn SinglePlayer mod!
//
//=====================================================================================//
...
////////////////////////////////////////////////////////////////////////
// kaitek666:	We had to comment some sections, because we don't really
//				need to allow player to change microphone and voice
//				comunication settings - It's damn singleplayer mod!
//
...
/////////////////////////////////////////////////////////////////////
// kaitek666:	I don't really think we need it
//
//
...
/*	if( !m_drpVoiceCommunication )
	...
	if( !m_pMicMeterIndicator )
	{
		...
		needsActivate = false;kaitek666: Will making this FALSE disable it?
	}  */

/////////////////////////////////////////////////////////////////////////
// kaitek666:	It has already been commented out. No need to change it.
//
//
// 	if( !m_btnCancel )
// 	{
...
void Audio::OnCommand(const char *command)
{
	...
	SetControlEnabled( "SldVoiceVoxThreshold", false );
//	SetControlEnabled( "Jukebox", false );
...
/////////////////////////////////////////////////////////
// kaitek666:	This, and all StartTestMicrophone have been
//				commented out.
//
//
...
/////////////////////////////////////////////////////////
// kaitek666:	This, and all EndTestMicrophone have been
//				commented out.
//
//
