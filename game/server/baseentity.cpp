...
IMPLEMENT_SERVERCLASS_ST_NOBASE( CBaseEntity, DT_BaseEntity )
	...
	SendPropBool( SENDINFO(m_bEnableGlow) ), SendPropInt( SENDINFO(m_GlowColor), 32, SPROP_UNSIGNED, SendProxy_Color32ToInt ),
...
//-----------------------------------------------------------------------------
// Purpose: L4D GLOW EFFECT
//-----------------------------------------------------------------------------
void CBaseEntity::InputGlowEffectOn( inputdata_t &inputdata )
{
	m_bEnableGlow.Set(true);
	DevMsg("			Glow effect on\n");
}

void CBaseEntity::InputGlowEffectOff( inputdata_t &inputdata )
{
	m_bEnableGlow.Set(false);
	DevMsg("			Glow effect off\n");
}
//-----------------------------------------------------------------------------
...
BEGIN_DATADESC_NO_BASE( CBaseEntity )
	...
	DEFINE_KEYFIELD( m_GlowColor, FIELD_COLOR32, "gloweffectcolor"),
...
//	DEFINE_FIELD( m_ToolHandle,		FIELD_INTEGER ),
	...
	DEFINE_INPUTFUNC( FIELD_VOID, "GlowEffectOn", InputGlowEffectOn ),
	DEFINE_INPUTFUNC( FIELD_VOID, "GlowEffectOff", InputGlowEffectOff ),
...
void CBaseEntity::SetGlow( bool state, Color glowColor /*=Color(255,255,255)*/ ) {
