...
set GAMEDIR=E:\Steam\SteamApps\common\alienswarm\Sleepless
...
set SDKBINDIR=..\..\..\..\Steam\SteamApps\common\alienswarm\bin
...
%BUILD_SHADER% deferred_shaders -game E:\Steam\SteamApps\common\alienswarm\Sleepless -source %SOURCEDIR% -dx9_30 -force30
